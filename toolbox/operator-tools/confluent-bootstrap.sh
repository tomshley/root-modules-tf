...
#
# Output:
#   Prints all values needed for .env files and committed terraform.tfvars.
...
echo "═══════════════════════════════════════════════════════════════════════════"
echo ""
echo "── .env file values (add to your streaming .env secure file) ──"
echo "CONFLUENT_CLOUD_API_KEY=$CLOUD_API_KEY"
echo "CONFLUENT_CLOUD_API_SECRET=$CLOUD_API_SECRET"
echo "TF_VAR_kafka_admin_api_key=$CLUSTER_API_KEY"
echo "TF_VAR_kafka_admin_api_secret=$CLUSTER_API_SECRET"
echo ""
...
#
# ── .env values (add to streaming .env secure file) ──
CONFLUENT_CLOUD_API_KEY=$CLOUD_API_KEY
CONFLUENT_CLOUD_API_SECRET=$CLOUD_API_SECRET
TF_VAR_kafka_admin_api_key=$CLUSTER_API_KEY
TF_VAR_kafka_admin_api_secret=$CLUSTER_API_SECRET
#
